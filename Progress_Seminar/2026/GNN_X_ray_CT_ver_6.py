#######################################################
#       Implementing "Categorical Focal Loss"         #
#                                                     #
#######################################################
import os
import numpy as np
...
def main():
    ...
    # Convert one-hot labels back to sparse integers for the plotting function
