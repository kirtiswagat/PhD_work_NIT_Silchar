...
class DualEfficientNetEncoder(Model):
    ...
    def _build_fusion_layer(self):
        ...
        self.fusion_layer = keras.Sequential([
                          layers.Lambda(lambda x: squeeze_and_excitation_block(x)), # Squeeze and Excitation Block
    ...
    def call(self, inputs, training=None):
        ...
        if isinstance(inputs, list) and len(inputs) == 2:
            ...
            # If single input provided, use it for both inputs
            input1 = input2 = inputs
